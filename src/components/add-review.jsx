      ...
      <div className="add-review">
        <form action="#" className="add-review__form">
          ...
          <div className="add-review__text">
            <textarea className="add-review__textarea" name="review-text" id="review-text" placeholder="Review text" style={{marginTop: 0, marginBottom: 0, height: 150}} defaultValue={``} />
